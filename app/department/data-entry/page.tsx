...
export default function DataEntryPage() {
  ...
  // Function to clear cache and refresh user data
  ...
  const onSubmit = async (data: DataEntryFormData) => {
    ...
    console.log("User hospital_id type:", typeof user.hospital_id);
    console.log("User hospital_id is null:", user.hospital_id === null);
    console.log("User hospital_id is undefined:", user.hospital_id === undefined);
    console.log("==========================");
